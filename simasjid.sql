...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Mar 2023 pada 10.19
...
--
-- Struktur dari tabel `tb_log_inventaris`
--
...
--
-- Struktur dari tabel `tb_log_kas`
--
...
--
-- Struktur dari tabel `tb_log_zakat_fitrah`
--
...
--
-- Struktur dari tabel `tb_log_zakat_mal`
--
...
--
-- Struktur dari tabel `tb_pengaturan_masjid`
--
...
--
-- Dumping data untuk tabel `tb_pengaturan_masjid`
--

INSERT INTO `tb_pengaturan_masjid` (`id_masjid`, `logo_masjid`, `icon_masjid`, `nama_masjid`, `alamat_masjid`, `telepon_masjid`, `email_masjid`) VALUES
(1, 'a1_ZGpMNMS4ENklpUXASv4zVw_rxqSKNLw_4795_123986745_cFVlC8_1679301492.webp', 'a1_VJV81bhkGTrdpLP1MMFKg_PHBWDMhF_8943_269345107_mogExQ_1679301492.webp', 'Al Ikhlas', 'Perum GCD Cilegon Banten', '+628179851011', 'alikhlas@aliklas.com');
...
INSERT INTO `tb_user` (`user_id`, `id_jabatan`, `real_name`, `user_name`, `user_password`, `user_email`, `user_token`, `last_login`, `last_ip`, `user_picture`, `is_active`) VALUES
(15, 1, 'Admin', 'admin', '$argon2id$v=19$m=2048,t=4,p=1$WVZaOGptd3pLQUdsSTB5VA$YNOyMCU/2yLe5i5jSbprq9KgHYwvCtmuzUfbgOccQ2Y', 'alikhlas@gmail.com', NULL, 1679324864, 0x00000000000000000000000000000001, 'user.jpg', 1),
(16, 9, 'Auditor', 'auditor', '$argon2id$v=19$m=2048,t=4,p=1$RDQxYnlJMkN3M1p1ZXdSTQ$1WL1MenseDEzh9XFeUutVyX1NJbb2elbPpZlq2KSRVk', 'auditor@auditor.com', 'BNiJTUPB3owFltfbC48SnjGT66QPfOXjpgqsNxGGdIO2h6qzx9CunQIC10olpwZ6wtqMNyvvxg-osoujwtcipA', 1679324959, 0x00000000000000000000000000000001, 'user.jpg', 1),
(17, 7, 'Petugas', 'petugas', '$argon2id$v=19$m=2048,t=4,p=1$ci9INUdmUEhSUnhiY25TWg$2P3KcvkgH2dJYljlk5b355ZgmGoFbWS8mNtO0qyunZk', 'petugas@gmail.com', 'Dv1_KuPAOqRXe_bG70x3YznZQD_v1TsTDB0NC-mMvJnsHuX5Od4Arn7bSwcMDuW36Smy4mvkhC0v7jKMoIxV8Q', 1679325045, 0x00000000000000000000000000000001, 'user.jpg', 1),
(18, 6, 'Ketua DKM', 'ketumdkm', '$argon2id$v=19$m=2048,t=4,p=1$Z0pyUGMyaXdhSTJuWDdGZA$5gZ4jo59Ud/ADCrlarzDzQapv0CK5FiHUvjqC/PhWZU', 'ketumdkm@gmail.com', 'sLJB3rBf7zXyXiqoXGj1ukCeB8R6LvEVzqTD_7LWzcHylOr48tTkbhHWjQcDUtnq6b2UJucWpWIYNidrnN1I5w', 1679325193, 0x00000000000000000000000000000001, 'user.jpg', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_user_type`
--
...
--
-- Dumping data untuk tabel `tb_user_type`
--
...
--
-- Struktur dari tabel `tb_zakat_mal`
--
...
--
-- Indeks untuk tabel `tb_log_inventaris`
--
ALTER TABLE `tb_log_inventaris`
  ADD PRIMARY KEY (`log_id`);

--
-- Indeks untuk tabel `tb_log_kas`
--
ALTER TABLE `tb_log_kas`
  ADD PRIMARY KEY (`log_id`);

--
-- Indeks untuk tabel `tb_log_zakat_fitrah`
--
ALTER TABLE `tb_log_zakat_fitrah`
  ADD PRIMARY KEY (`log_id`);

--
-- Indeks untuk tabel `tb_log_zakat_mal`
--
...
--
-- Indeks untuk tabel `tb_pengaturan_masjid`
--
...
--
-- Indeks untuk tabel `tb_user_type`
--
...
--
-- Indeks untuk tabel `tb_zakat_mal`
--
...
--
-- AUTO_INCREMENT untuk tabel `tb_log_inventaris`
--
ALTER TABLE `tb_log_inventaris`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_log_kas`
--
ALTER TABLE `tb_log_kas`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_log_zakat_fitrah`
--
ALTER TABLE `tb_log_zakat_fitrah`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_log_zakat_mal`
--
ALTER TABLE `tb_log_zakat_mal`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `tb_mustahik`
--
ALTER TABLE `tb_mustahik`
  MODIFY `id_mustahik` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tb_pengaturan_masjid`
--
ALTER TABLE `tb_pengaturan_masjid`
  MODIFY `id_masjid` tinyint(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tb_user`
  MODIFY `user_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `tb_user_type`
--
ALTER TABLE `tb_user_type`
...
--
-- AUTO_INCREMENT untuk tabel `tb_zakat_mal`
--
ALTER TABLE `tb_zakat_mal`
  MODIFY `id_transaksi` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Ketidakleluasaan untuk tabel `tb_kas_masjid`
--
ALTER TABLE `tb_kas_masjid`
...
--
-- Ketidakleluasaan untuk tabel `tb_memo`
--
ALTER TABLE `tb_memo`
...
--
-- Ketidakleluasaan untuk tabel `tb_zakat_mal`
--
ALTER TABLE `tb_zakat_mal`
